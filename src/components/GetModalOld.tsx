...
const GetModal = (props: GetModalProps) => {
  ...
  const handleAcceptResolve = () => acceptResolveRef.current(true);

  // const [acceptResolve, _setAcceptResolve] = useState<any>(null);
  // const acceptResolveRef = useRef<any>(acceptResolve);
  // const setAcceptResolve = (data: any) => {
  //   acceptResolveRef.current = data;
  //   _setAcceptResolve(data);
  // };
